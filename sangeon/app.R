...
output$partplot<-renderPlot({
  ...
  radarchart(data, axistype=1, 
   ...
   legend(x=1.3, y=1.3, legend = c("초","중","고"), bty = "n", pch=20 , col=colors_in , text.col = "grey", cex=1.2, pt.cex=3)         
  
})
output$partplot1<-renderPlot({
